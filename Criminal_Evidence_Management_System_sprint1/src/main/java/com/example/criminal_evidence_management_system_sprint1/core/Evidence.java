...
public class Evidence {
    ...
    public Evidence(Integer evidenceId, CriminalCase criminalCase, Storage storage, String number, String itemName, String notes, Boolean archived, Set<TrackEntry> trackEntries) {
        this.evidenceId = evidenceId;
        this.criminalCase = criminalCase;
        this.storage = storage;
        this.number = number;
